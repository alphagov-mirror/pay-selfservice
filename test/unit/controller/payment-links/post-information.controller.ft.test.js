...
describe('Create payment link information controller', () => {
  ...
  describe(`when no paymentLinkTitle is submitted`, () => {
    ...
    it('should add a relevant error message to the session \'flash\'', () => {
      ...
      expect(session.flash.genericErrorOld[0]).to.equal('<h2>There was a problem with the details you gave for:</h2><ul class="govuk-list govuk-error-summary__list"><li><a href="#payment-link-title">Title</a></li></ul>')
    })
  })
})
