...
describe('Check "VAT number" not submitted middleware', () => {
  ...
  it('should redirect to the dashboard with error message when "VAT number" flag is true', done => {
    ...
    setTimeout(() => {
      ...
      expect(req.flash.calledWith('genericError', 'You’ve already provided your VAT number.<br />Contact GOV.UK Pay support if you need to update them.')).to.be.true // eslint-disable-line
