...
module.exports = (req, res) => {
  ...
  if (!paymentAmountType) {
    req.flash('genericErrorOld', `<h2>There was a problem with the details you gave for:</h2><ul class="govuk-list govuk-error-summary__list"><li><a href="#fixed-or-variable">Is the payment for a fixed amount?</a></li></ul>`)
  ...
  if (paymentLinkAmount !== '' && formattedPaymentLinkAmount === null) {
    req.flash('genericErrorOld', `<h2>There was a problem with the details you gave for:</h2><ul class="govuk-list govuk-error-summary__list"><li><a href="#payment-amount">Enter the amount</a></li></ul>`)
