...
module.exports = (req, res) => {
  ...
  if (!paymentReferenceType) {
    req.flash('genericErrorOld', `<h2>There was a problem with the details you gave for:</h2><ul class="govuk-list govuk-error-summary__list"><li><a href="#standard-or-custom-ref">Would you like us to create a payment reference number for your users?</a></li></ul>`)
  ...
  if (paymentReferenceType === 'custom') {
    if (paymentReferenceLabel === '') {
      req.flash('genericErrorOld', `<h2>There was a problem with the details you gave for:</h2><ul class="govuk-list govuk-error-summary__list"><li><a href="#reference-label">Name of your payment reference number</a></li></ul>`)
