...
module.exports = (req, res) => {
  ...
  if (editData.name === '') {
    req.flash('genericErrorOld', `<h2>There was a problem with the details you gave for:</h2><ul class="error-summary-list"><li><a href="#payment-link-title">Title</a></li></ul>`)
