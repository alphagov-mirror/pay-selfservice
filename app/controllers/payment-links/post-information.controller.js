...
module.exports = (req, res) => {
  ...
  if (updatedPageData.paymentLinkTitle === '') {
    req.flash('genericErrorOld', `<h2>There was a problem with the details you gave for:</h2><ul class="govuk-list govuk-error-summary__list"><li><a href="#payment-link-title">Title</a></li></ul>`)
